...
const{messages,getMessages,isMessagesLoading,selectedUser,subscribeToMessages,unsubscribeFromMesaages}=useChatStore()
...
},[selectedUser._id,getMessages,subscribeToMessages,unsubscribeFromMesaages])

useEffect(()=>{
  if(messageEndRef && messages){
messageEndRef.current.scroolIntoView({behavior:"smooth"})}
},[messages])
